...
export const INITIAL_POSITIONS: PortfolioPosition[] = [
  ...
  { id: '4', ticker: 'YSTL.TO', shares: 200, purchaseDate: '2024-01-10', purchasePrice: 15.40 },
  { id: '5', ticker: 'PLTE.TO', shares: 500, purchaseDate: '2024-02-15', purchasePrice: 8.20 },
  { id: '6', ticker: 'CDAY.TO', shares: 50, purchaseDate: '2024-03-01', purchasePrice: 92.50 },
];
...
export const MOCK_DIVIDENDS: Record<string, DividendData[]> = {
  ...
  'YSTL.TO': [
    { ticker: 'YSTL.TO', exDate: '2024-05-30', recordDate: '2024-05-31', payoutDate: '2024-06-07', amountPerShare: 0.12, yield: 8.5 },
    { ticker: 'YSTL.TO', exDate: '2024-04-29', recordDate: '2024-04-30', payoutDate: '2024-05-07', amountPerShare: 0.12, yield: 8.4 },
    { ticker: 'YSTL.TO', exDate: '2024-03-27', recordDate: '2024-03-28', payoutDate: '2024-04-05', amountPerShare: 0.11, yield: 8.2 },
  ],
  'PLTE.TO': [
    { ticker: 'PLTE.TO', exDate: '2024-05-28', recordDate: '2024-05-29', payoutDate: '2024-06-05', amountPerShare: 0.08, yield: 12.1 },
    { ticker: 'PLTE.TO', exDate: '2024-04-26', recordDate: '2024-04-29', payoutDate: '2024-05-06', amountPerShare: 0.08, yield: 11.9 },
    { ticker: 'PLTE.TO', exDate: '2024-03-27', recordDate: '2024-03-28', payoutDate: '2024-04-05', amountPerShare: 0.075, yield: 11.5 },
  ],
  'CDAY.TO': [
    { ticker: 'CDAY.TO', exDate: '2024-06-14', recordDate: '2024-06-17', payoutDate: '2024-06-28', amountPerShare: 0.15, yield: 1.2 },
    { ticker: 'CDAY.TO', exDate: '2024-03-14', recordDate: '2024-03-15', payoutDate: '2024-03-29', amountPerShare: 0.15, yield: 1.1 },
  ]
};
...
export const INITIAL_TRANSACTIONS: TransactionRecord[] = [
  ...
  { id: 't4', ticker: 'YSTL.TO', type: 'buy', date: '2024-01-10', shares: 200, price: 15.40, totalAmount: 3080 },
  { id: 't5', ticker: 'PLTE.TO', type: 'buy', date: '2024-02-15', shares: 500, price: 8.20, totalAmount: 4100 },
  { id: 't6', ticker: 'AAPL', type: 'dividend', date: '2024-02-15', shares: 50, price: 0, totalAmount: 12.00 },
];
